...
{isDetailOpen && (
        ...
        >
          <div 
            className="relative w-full max-h-[78%] sm:max-h-[80vh] sm:max-w-lg bg-card border-t sm:border border-border/80 rounded-t-[28px] sm:rounded-[24px] shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom duration-300"
            onClick={(e) => e.stopPropagation()}
          >
...
<div className="overflow-y-auto px-6 popup-content-padding pt-2 sm:pt-6 space-y-8 flex-1 no-scrollbar overscroll-y-contain">
...
{steps && steps.length > 0 && (
            ...
            <div className="absolute popup-buttons left-6 right-6 flex items-center justify-between pointer-events-none z-20">
