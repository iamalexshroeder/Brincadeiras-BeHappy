    ...
    games: [
      {
        ...
        title: "O Lobo",
        description:
          "Uma emocionante brincadeira de suspense e perseguição onde os pequenos devem encontrar o lobo escondido e fugir para a casa.",
        duration: "15-20 min",
        participants: "4+",
        age: "4+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Atividade para trabalhar lateralidade e reflexo, onde as crianças respondem aos comandos do Monitor.",
        duration: "15-20 min",
        participants: "4+",
        age: "4+ anos",
      ...
      },
      {
        ...
        title: "Campo Minado",
        description:
          "Teste de confiança onde as crianças atravessam um circuito guiadas apenas pela voz dos colegas.",
        duration: "15-20 min",
        participants: "4+",
        age: "4+ anos",
      ...
      },
      {
        ...
        title: "A Sombra",
        description:
          "Jogo de imitação e observação que estimula a criatividade e a coordenação motora em duplas.",
        duration: "10-15 min",
        participants: "4+",
        age: "4+ anos",
        materials: [],
        steps: [
          ...
          "Variação: Use trios ou quartetos onde todos devem imitar o Monitor da fila.",
        ],
      },
      {
        id: "pdf-9",
        title: "Medusa",
        description:
          "Variação emocionante do jogo de 'estátua', onde as crianças tentam tocar o Monitor sem serem vistas.",
        duration: "15-20 min",
        participants: "4+",
        age: "4+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Jogo dinâmico de troca de lugares que promove a interação e a diversão coletiva.",
        duration: "15-20 min",
        participants: "6+",
        age: "4+ anos",
        materials: [],
      ...
      },
      {
        ...
        title: "Mãos de Cores",
        description:
          "Atividade sensorial que mistura reconhecimento de cores com alongamento e contato social leve.",
        duration: "15-20 min",
        participants: "4+",
        age: "4+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Clássico jogo de exploração adaptado para os pequenos, estimulando a curiosidade e o foco.",
        duration: "15-20 min",
        participants: "4+",
        age: "3+ anos",
      ...
      },
      {
        ...
        description:
          "Gincana de equilíbrio e força que desafia as crianças a completarem um percurso em uma perna.",
        duration: "10-15 min",
        participants: "4+",
        age: "4+ anos",
      ...
      },
      {
        ...
        title: "O Camaleão",
        description:
          "Jogo de perseguição e cores onde as crianças buscam proteção no objeto da cor certa.",
        duration: "15-20 min",
        participants: "4+",
        age: "3+ anos",
        materials: [],
      ...
      },
      {
        ...
        title: "A Fila Viva",
        description:
          "Exercício de coordenação onde todos se movem como um único organismo de mãos dadas.",
        duration: "10-15 min",
        participants: "4+",
        age: "3+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Variação do 'Mestre Mandou' que exercita a atenção e a criatividade motora.",
        duration: "10-15 min",
        participants: "4+",
        age: "3+ anos",
        materials: [],
      ...
      },
      {
        ...
        title: "Céu e Terra",
        description:
          "Jogo de oposição e reflexo que ajuda a distinguir comandos e aprimorar o salto.",
        duration: "10-15 min",
        participants: "4+",
        age: "3+ anos",
      ...
      },
      {
        ...
        description:
          "Desafio de coordenação onde as crianças cruzam um 'rio' usando apenas pedras de papel.",
        duration: "15-20 min",
        participants: "4+",
        age: "4+ anos",
      ...
      },
      {
        ...
        description:
          "Pega-pega cooperativo onde os 'enfeitiçados' precisam da ajuda dos amigos para voltarem.",
        duration: "15-20 min",
        participants: "6+",
        age: "3+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Exercício de autocontrole e expressão facial, ideal para momentos de calma e foco.",
        duration: "10-15 min",
        participants: "2+",
        age: "3+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Brincadeira lúdica de equilíbrio e cooperação usando desenhos narrativos no chão.",
        duration: "15-20 min",
        participants: "4+",
        age: "4+ anos",
      ...
      },
      {
        ...
        description:
          "Pega-pega dramático com regras de tempo que tornam a perseguição estratégica.",
        duration: "15-20 min",
        participants: "6+",
        age: "3+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Variação do caça ao tesouro que utiliza pontuações por cor para estimular a observação.",
        duration: "15-20 min",
        participants: "4+",
        age: "4+ anos",
      ...
      },
      {
        ...
        title: "Chefe Comanda",
        description:
          "Jogo de imitação que reforça o seguimento de instruções e a coordenação motora.",
        duration: "10-15 min",
        participants: "4+",
        age: "3+ anos",
        materials: [],
      ...
      },
      {
        ...
        title: "Balão Fujão",
        description:
          "Atividade de controle motor onde as crianças guiam um balão apenas usando o vento.",
        duration: "10-15 min",
        participants: "2+",
        age: "3+ anos",
      ...
      },
      {
        ...
        description:
          "Atividade sensorial onde a criança identifica objetos usando apenas o tato.",
        duration: "15-20 min",
        participants: "4+",
        age: "4+ anos",
    ...
    games: [
      {
        ...
        description:
          "Percurso psicomotor para trabalhar velocidade, lateralidade e coordenação de forma dinâmica.",
        duration: "15-20 min",
        participants: "4+",
        age: "3+ anos",
    ...
    games: [
      {
        ...
        description:
          "Brincadeira de congelar no tempo que treina o controle auditivo e a atenção de forma divertida.",
        duration: "15-20 min",
        participants: "4+",
        age: "3+ anos",
      ...
      },
      {
        ...
        description:
          "Jogo clássico de velocidade e percepção onde os lugares diminuem a cada rodada.",
        duration: "15-20 min",
        participants: "5+",
        age: "3+ anos",
      ...
      },
      {
        ...
        description:
          "Brincadeira de escuta e comunicação que termina em boas risadas com as mensagens transformadas.",
        duration: "10-15 min",
        participants: "4+",
        age: "5+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Batalha estratégica entre equipes que transforma o clássico jogo em uma vibrante disputa de grupo.",
        duration: "15-20 min",
        participants: "8+",
        age: "6+ anos",
        materials: [],
      ...
      },
      {
        ...
        title: "Sardinha",
        description:
          "Esconde-esconde invertido onde quem encontra a sardinha se junta a ela em silêncio.",
        duration: "15-20 min",
        participants: "4+",
        age: "6+ anos",
        materials: [],
      ...
      },
      {
        ...
        title: "Nó Maluco",
        description:
          "Quebra-cabeça físico cooperativo que exige comunicação para desatar o nó humano sem soltar as mãos.",
        duration: "15-20 min",
        participants: "8+",
        age: "8+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Jogo de dedução e interpretação cercado de mistério, focando em descobrir os vilões do grupo.",
        duration: "20-30 min",
        participants: "8+",
        age: "10+ anos",
    ...
    games: [
      {
        ...
        description:
          "Variação veloz em círculo que exige atenção constante e reflexos rápidos para os números sorteados.",
        duration: "15-20 min",
        participants: "8+",
        age: "4+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Desafio de invasão onde forasteiros cruzam uma área protegida por guardiões.",
        duration: "15-20 min",
        participants: "8+",
        age: "4+ anos",
      ...
      },
      {
        ...
        description:
          "Jogo de perseguição e reconhecimento de cores onde possuir a cor certa garante segurança.",
        duration: "15-20 min",
        participants: "6+",
        age: "3+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Brincadeira temática de perseguição onde todos se movem apenas em um pé.",
        duration: "15-20 min",
        participants: "6+",
        age: "4+ anos",
        materials: [],
      ...
      },
      {
        ...
        title: "Congelado",
        description:
          "Clássico pega-pega que incentiva o altruísmo ao salvar amigos imobilizados pelo toque.",
        duration: "15-20 min",
        participants: "6+",
        age: "3+ anos",
        materials: [],
      ...
      },
      {
        ...
        title: "Arranca Rabo",
        description:
          "Gincana de agilidade onde crianças protegem sua 'cauda' enquanto buscam capturar as dos adversários.",
        duration: "15-20 min",
        participants: "6+",
        age: "4+ anos",
      ...
      },
      {
        ...
        description:
          "Mistura criativa de perseguição e teatro onde amigos são salvos através da imitação fiel de poses.",
        duration: "15-20 min",
        participants: "6+",
        age: "3+ anos",
        materials: [],
      ...
      },
      {
        ...
        title: "Caça Palitos",
        description:
          "Jogo de perseguição que usa Jo-ken-pô para disputar recursos, estimulando agilidade e sorte.",
        duration: "15-20 min",
        participants: "6+",
        age: "5+ anos",
      ...
      },
      {
        ...
        description:
          "Exercício vibrante de cooperação onde a cabeça do dragão deve capturar sua própria cauda.",
        duration: "15-20 min",
        participants: "6+",
        age: "4+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Jogo de perseguição em limites restringidos que treina equilíbrio e salto coordenado agachado.",
        duration: "15-20 min",
        participants: "4+",
        age: "4+ anos",
        materials: ["Giz"],
      ...
      },
      {
        ...
        description:
          "Variação do corre-cutia que utiliza um objeto para marcar o início de uma perseguição circular.",
        duration: "15-20 min",
        participants: "6+",
        age: "4+ anos",
      ...
      },
      {
        ...
        description:
          "Jogo de exploração com funções secretas que trazem um clima de aventura épica ao grupo.",
        duration: "15-20 min",
        participants: "8+",
        age: "3+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Pega-pega dinâmico de percepção visual onde o ambiente interativo se torna o foco.",
        duration: "10-15 min",
        participants: "4+",
        age: "4+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Aventura cooperativa onde magos coletam ingredientes sem serem pegos pelo monstro guardião.",
        duration: "15-20 min",
        participants: "6+",
        age: "4+ anos",
      ...
      },
      {
        ...
        description:
          "Exercício de prontidão que transforma a inicial do nome de cada um em um gatilho de ação.",
        duration: "15-20 min",
        participants: "8+",
        age: "6+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Jogo de observação e discrição onde um assassino silencioso tenta eliminar as vítimas sem ser descoberto.",
        duration: "15-20 min",
        participants: "6+",
        age: "6+ anos",
      ...
      },
      {
        ...
        title: "PACMAN Humano",
        description:
          "Emocionante pega-pega de restrição espacial focado nas linhas de marcação do chão.",
        duration: "15-20 min",
        participants: "6+",
        age: "6+ anos",
      ...
      },
      {
        ...
        description:
          "Variação estratégica onde os participantes sentados servem como base para a troca imediata de papéis.",
        duration: "15-20 min",
        participants: "8+",
        age: "6+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Perseguição coletiva onde a captura é feita com bambolês, criando uma corrente crescente de pegadores.",
        duration: "15-20 min",
        participants: "8+",
        age: "6+ anos",
        materials: ["Bambolês"],
      ...
      },
      {
        ...
        title: "Mico Preto",
        description:
          "Desafio de travessia e agilidade onde um guardião central tenta capturar os caçadores velozes.",
        duration: "15-20 min",
        participants: "4+",
        age: "4+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Gincana competitiva de coleta que estimula a rapidez na organização de recursos espaciais.",
        duration: "15-20 min",
        participants: "6+",
        age: "5+ anos",
      ...
      },
      {
        ...
        description:
          "Desafio de agilidade e estratégia onde participantes buscam reunir itens na base em tempo recorde.",
        duration: "15-20 min",
        participants: "4+",
        age: "Livre",
      ...
      },
      {
        ...
        description:
          "Jogo de perseguição mútua onde o tema escolhido pelo Monitor define os próximos alvos.",
        duration: "15-20 min",
        participants: "6+",
        age: "7+ anos",
      ...
      },
      {
        ...
        title: "Pique-Cai-Cai",
        description:
          "Brincadeira bem-humorada onde os 'caídos' dependem do resgate unido dos amigos.",
        duration: "15-20 min",
        participants: "6+",
        age: "Livre",
        materials: [],
      ...
      },
      {
        ...
        title: "Pega-Pregador",
        description:
          "Jogo de agilidade e 'vidas' móveis que exige rapidez e disputas francas de sorte.",
        duration: "20-25 min",
        participants: "6+",
        age: "Livre",
      ...
      },
      {
        ...
        description:
          "Teste de fôlego e velocidade onde os pontos de segurança estão sempre cruzando o campo.",
        duration: "15-20 min",
        participants: "4+",
        age: "7+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Clássico jogo onde a captura funde participantes em uma única rede de perseguição crescente.",
        duration: "15-20 min",
        participants: "4+",
        age: "7+ anos",
        materials: [],
      ...
      },
      {
        ...
        title: "Chinelinho",
        description:
          "Competição de equipe baseada em disputas individuais por um objeto central.",
        duration: "15-20 min",
        participants: "4+",
        age: "7+ anos",
      ...
      },
      {
        ...
        description:
          "Pega-pega de equipe com regras de prisão e resgate que geram dinâmicas longas e divertidas.",
        duration: "15-20 min",
        participants: "4+",
        age: "8+ anos",
        materials: [],
      ...
      },
      {
        ...
        title: "Rua e Avenida",
        description:
          "Labirinto dinâmico onde as passagens abrem e fecham conforme os comandos do Monitor.",
        duration: "15-20 min",
        participants: "10+",
        age: "8+ anos",
        materials: [],
      ...
      },
      {
        ...
        title: "Mãe da Rua",
        description:
          "Desafio de travessia lateral onde os participantes tentam cruzar uma linha defendida.",
        duration: "15-20 min",
        participants: "4+",
        age: "8+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Teste clássico de estratégia, invasão e defesa focado na captura de um totem adversário.",
        duration: "15-20 min",
        participants: "6+",
        age: "8+ anos",
      ...
      },
      {
        ...
        description:
          "Perseguição circular com troca de papéis baseada no posicionamento tático em duplas.",
        duration: "15-20 min",
        participants: "6+",
        age: "8+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Disputa baseada em cálculos e paridade, onde a resposta dita quem caça e quem foge.",
        duration: "15-20 min",
        participants: "6+",
        age: "10+ anos",
        materials: [],
      ...
      },
      {
        ...
        title: "Nunca 3",
        description:
          "Pega-pega de fluidez constante onde alinhamentos de trios forçam trocas imediatas de corredores.",
        duration: "15-20 min",
        participants: "6+",
        age: "7+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Mini-enigma temático onde a solução de pistas é o único caminho para a liberdade.",
        duration: "15-20 min",
        participants: "4+",
        age: "Livre",
      ...
      },
      {
        ...
        title: "Trunfo Real",
        description:
          "Batalha de atributos onde cards personalizados definem o poder de cada jogador no campo.",
        duration: "20-30 min",
        participants: "6+",
        age: "Livre",
      ...
      },
      {
        ...
        description:
          "Jogo de defesa tática onde um Monitor deve ser guardado por seu exército fiel.",
        duration: "15-20 min",
        participants: "4+",
        age: "Livre",
      ...
      },
      {
        ...
        title: "Passaporte",
        description:
          "Busca exploratória por selos coloridos enquanto se evita o fiscal 'tira-visto' no percurso.",
        duration: "15-20 min",
        participants: "6+",
        age: "Livre",
        ...
        steps: [
          ...
          "Ganha quem conseguir todos os vistos coloridos sem sofrer a penalidade do fiscal pegador.",
        ],
      },
    ],
  },
    ...
    games: [
      {
        ...
        description:
          "Competição de corrida e agilidade onde equipes lutam para capturar o tesouro central.",
        duration: "15-20 min",
        participants: "8+",
        age: "4+ anos",
        materials: ["Cone", "Bola"],
      ...
      },
      {
        ...
        description:
          "Exercício de precisão onde times tentam empurrar um alvo central usando arremessos precisos.",
        duration: "15-20 min",
        participants: "6+",
        age: "5+ anos",
      ...
      },
      {
        ...
        description:
          "Gincana de revezamento que exige coordenação e sincronia para o transporte da esfera.",
        duration: "15-20 min",
        participants: "8+",
        age: "4+ anos",
        materials: ["2 Bolas"],
      ...
      },
      {
        ...
        description:
          "Jogo de reflexos rápidos onde o comando vocal dita a ação até o desafio final pela bola.",
        duration: "10-15 min",
        participants: "4+",
        age: "4+ anos",
      ...
      },
      {
        ...
        description:
          "Atividade de busca que transforma o espaço em um campo de tesouros escondidos e frágeis.",
        duration: "15-20 min",
        participants: "4+",
        age: "3+ anos",
      ...
      },
      {
        ...
        description:
          "Pega-pega com bola que utiliza o contato físico amigável como porto seguro temporário.",
        duration: "15-20 min",
        participants: "6+",
        age: "6+ anos",
      ...
      },
      {
        ...
        description:
          "Gincana de agilidade onde a bola percorre um caminho de pontes humanas em movimento.",
        duration: "15-20 min",
        participants: "8+",
        age: "6+ anos",
      ...
      },
      {
        ...
        title: "Alerta",
        description:
          "O jogador joga a bola para cima e grita o nome de alguém, forçando paradas estratégicas no campo.",
        duration: "15-20 min",
        participants: "4+",
        age: "6+ anos",
        materials: ["Uma bola"],
      ...
      },
      {
        ...
        description:
          "Variação do jogo de argolas onde o objetivo é cercar o colega com o aro lançado.",
        duration: "15-20 min",
        participants: "4+",
        age: "6+ anos",
        materials: ["Bambolês"],
      ...
      },
      {
        ...
        description:
          "Jogo de equipe estratégico onde a vitória depende da proteção absoluta do Monitor escolhido.",
        duration: "15-20 min",
        participants: "8+",
        age: "6+ anos",
      ...
      },
      {
        ...
        description:
          "O Monitor determina um fugitivo enquanto o grupo tenta acioná-lo através de passes rápidos.",
        duration: "15-20 min",
        participants: "6+",
        age: "7+ anos",
        materials: ["Bola"],
      ...
      },
      {
        ...
        description:
          "Desafio de prontidão onde números chamados competem pela posse da bola central e finalização.",
        duration: "15-20 min",
        participants: "6+",
        age: "7+ anos",
      ...
      },
      {
        ...
        title: "7 Caquinhos",
        description:
          "Teste de mira e proteção onde reconstruir o alvo é o principal desafio sob fogo inimigo.",
        duration: "15-20 min",
        participants: "8+",
        age: "7+ anos",
      ...
      },
      {
        ...
        title: "Artilharia",
        description:
          "Batalha de precisão onde derrubar a base inimiga é apenas o início do desafio de reconstrução.",
        duration: "15-20 min",
        participants: "6+",
        age: "7+ anos",
      ...
      },
      {
        ...
        description:
          "Variação cooperativa do vôlei onde a bola é lançada e capturada usando tecidos em sincronia.",
        duration: "20-25 min",
        participants: "8+",
        age: "8+ anos",
      ...
      },
      {
        ...
        title: "Rede Humana",
        description:
          "Desafio dinâmico onde uma barreira viva de jogadores tenta interceptar passes aéreos entre times.",
        duration: "15-20 min",
        participants: "10+",
        age: "8+ anos",
        materials: ["Uma bola"],
      ...
      },
      {
        ...
        title: "Hand-Fut",
        description:
          "Esporte híbrido que combina a condução manual do handebol com a finalização podálica do futebol.",
        duration: "20-30 min",
        participants: "8+",
        age: "8+ anos",
      ...
      },
      {
        ...
        title: "Bruxa / Caçador",
        description:
          "Batalha de campos onde a mira define quem permanece vivo na disputa por territórios.",
        duration: "15-20 min",
        participants: "6+",
        age: "8+ anos",
      ...
      },
      {
        ...
        description:
          "Jogo de posse de bola e estratégia onde a finalização exige uma sequência perfeita prévia.",
        duration: "15-20 min",
        participants: "8+",
        age: "8+ anos",
      ...
      },
      {
        ...
        title: "Basquete 21",
        description:
          "Desafio de arremessos rápido focado na precisão e no aproveitamento tático do rebote.",
        duration: "20-25 min",
        participants: "3+",
        age: "9+ anos",
      ...
      },
      {
        ...
        description:
          "Gincana de velocidade onde equipes tentam alinhar 3 bolas em um tabuleiro gigante de bambolês.",
        duration: "15-20 min",
        participants: "6+",
        age: "8+ anos",
      ...
      },
      {
        ...
        description:
          "Desafio físico intenso de força onde o futebol é disputado em postura corporal invertida.",
        duration: "15-20 min",
        participants: "8+",
        age: "8+ anos",
        materials: ["Uma bola"],
      ...
      },
      {
        ...
        title: "Base Sete",
        description:
          "Corrida inspirada no beisebol que integra o uso de bambolês como bases de segurança e pontos.",
        duration: "20-25 min",
        participants: "8+",
        age: "8+ anos",
      ...
      },
      {
        ...
        description:
          "Versão épica e estratégica de queimada com múltiplas bolas e regras especiais de resgate coletivo.",
        duration: "20-30 min",
        participants: "10+",
        age: "8+ anos",
      ...
      },
      {
        ...
        description:
          "Exercício de prontidão focado no controle motor onde o Monitor utiliza fintas e blefes.",
        duration: "10-15 min",
        participants: "6+",
        age: "7+ anos",
      ...
      },
      {
        ...
        title: "Vôlei-Pega",
        description:
          "Fusão frenética de voleibol e pega-pega, onde erros em quadra geram perseguições fatais.",
        duration: "20-25 min",
        participants: "8+",
        age: "8+ anos",
      ...
      },
      {
        ...
        description:
          "Gincana de busca e resgate com temas de aventura, onde fugir do caçador exige foco total.",
        duration: "20-30 min",
        participants: "8+",
        age: "Livre",
      ...
      },
      {
        ...
        description:
          "Duas equipes defendem seu cone central enquanto tentam derrubar o cone rival usando a bola.",
        duration: "15-20 min",
        participants: "4+",
        age: "Livre",
    ...
    games: [
      {
        ...
        description:
          "Jogo de agilidade e exclusão lúdica onde o foco é garantir seu lugar seguro.",
        duration: "15-20 min",
        participants: "6+",
        age: "4+ anos",
      ...
      },
      {
        ...
        description:
          "Gincana agitada que exige cuidado ao proteger sua cauda e atacar a dos adversários.",
        duration: "15-20 min",
        participants: "8+",
        age: "5+ anos",
      ...
      },
      {
        ...
        description:
          "Estratégia e arremesso onde a comunicação e a sorte guiam os ataques sobre a barreira.",
        duration: "20-25 min",
        participants: "8+",
        age: "6+ anos",
      ...
      },
      {
        ...
        description:
          "Gincana caótica que testa a organização sob pressão e o rápido reconhecimento de pertences.",
        duration: "15-20 min",
        participants: "8+",
        age: "6+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Jogo de memória e ritmo inspirado no clássico eletrônico, usando saltos e gestos físicos.",
        duration: "15-20 min",
        participants: "6+",
        age: "8+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Agilidade e sorte utilizando bambolês como um tabuleiro humano para disputas de Jo-ken-pô.",
        duration: "15-20 min",
        participants: "6+",
        age: "6+ anos",
      ...
      },
      {
        ...
        description:
          "Reflexo e velocidade onde o toque na mão inicia uma perseguição explosiva pela quadra.",
        duration: "15-20 min",
        participants: "8+",
        age: "7+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Gincana de batalha baseada na hierarquia onde proteger o Monitor é o objetivo místico.",
        duration: "20-25 min",
        participants: "8+",
        age: "7+ anos",
      ...
      },
      {
        ...
        title: "Stop Express",
        description:
          "Gincana intelectual que combina o jogo de palavras com revezamento físico agitado.",
        duration: "15-20 min",
        participants: "6+",
        age: "8+ anos",
        materials: ["Papel e caneta"],
      ...
      },
      {
        ...
        title: "Passos Unidos",
        description:
          "Exercício de sincronia onde duplas unidas pelos tornozelos devem se mover juntas.",
        duration: "10-15 min",
        participants: "4+",
        age: "8+ anos",
      ...
      },
      {
        ...
        description:
          "Desafio exigente que testa a resistência e a sincronia motora em fileira humana.",
        duration: "15-20 min",
        participants: "6+",
        age: "10+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Jogo de adivinhação e mímica que recompensa o conhecimento e sorte punitiva lúdica.",
        duration: "15-20 min",
        participants: "6+",
        age: "Livre",
        materials: [],
        steps: [
          ...
          "Se a palavra 'Mango' surgir no sorteio, o Monitor atual escolhe um mico para o rival.",
    ...
    games: [
      {
        ...
        description:
          "Versão cooperativa da dança das cadeiras focada no apoio mútuo e inclusão total.",
        duration: "15-20 min",
        participants: "6+",
        age: "4+ anos",
        materials: ["Cadeiras"],
      ...
      },
      {
        ...
        description:
          "Jogo de vocabulário e rapidez mental onde participantes competem contra o cronômetro.",
        duration: "15-20 min",
        participants: "4+",
        age: "8+ anos",
      ...
      },
      {
        ...
        description:
          "Exercício de memória cumulativa onde o grupo constrói uma lista gigante sem erros.",
        duration: "15-20 min",
        participants: "4+",
        age: "8+ anos",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Duelo auditivo emocionante onde participantes vendados se encontram por sinais sonoros.",
        duration: "15-20 min",
        participants: "8+",
        age: "7+ anos",
        materials: ["Vendas"],
      ...
      },
      {
        ...
        description:
          "Versão gigante do jogo de pares onde os próprios participantes são as peças ocultas.",
        duration: "20-25 min",
        participants: "10+",
        age: "Livre",
        materials: [],
      ...
      },
      {
        ...
        description:
          "Simulação cômica de tribunal onde a retórica criativa define a absolvição ou condenação.",
        duration: "25-40 min",
        participants: "6+",
        age: "Livre",
      ...
      },
      {
        ...
        description:
          "Mistério de alta pressão onde evidências cruciais estão ocultas dentro de bexigas.",
        duration: "20-30 min",
        participants: "8+",
        age: "Livre",
